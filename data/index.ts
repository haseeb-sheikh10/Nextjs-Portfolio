...
export const gridItems = [
  {
    ...
    description: "",
    className:
      "col-span-1  lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
  ...
  },
  {
    ...
    description: "",
    className: "col-span-1 lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  },
  {
    ...
    description: "",
    className: "col-span-1 lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
    spareImg: "/b4.svg",
